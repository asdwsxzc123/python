...
class RegisterForm(FlaskForm):
  ...
  password2 = PasswordField(label=u'确认密码', validators=[DataRequired(u"密码不能为空"), EqualTo('password', u'两次密码不一致')])
...
def index():
  ...
  return 'index page, session: %s' % user_name
